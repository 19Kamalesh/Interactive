...
<body>
    ...
    <div style="white-space: nowrap; overflow-x: auto; padding: 1rem;">
        ...
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="Goodfellas.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block; margin-right: 10px;" onclick="openModal(this)">
            <img src="raging-bull.jpg" style="height: 200px;">
        </div>
        <div style="display: inline-block;" onclick="openModal(this)">
            <img src="The_Irishman_poster.jpg" style="height: 200px;">
        </div>
    </div>
...
```
## OUTPUT:
![alt text](<imageapp/static/Screenshot 2025-12-17 162517.png>)
![alt text](<imageapp/static/Screenshot 2025-12-17 162603.png>)
## RESULT:
